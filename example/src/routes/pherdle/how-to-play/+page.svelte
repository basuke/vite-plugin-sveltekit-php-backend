<svelte:head>
	<title>How to play Pherdle</title>
	<meta name="description" content="How to play Pherdle" />
</svelte:head>

<div class="text-column">
	<h1>How to play Pherdle</h1>

	<p>
		Pherdle is port of Swerdle which is a clone of <a href="https://www.nytimes.com/games/wordle/index.html">Wordle</a>, the
	...
	<p>
		Unlike the original Wordle, Pherdle runs on the server instead of in the browser, making it
